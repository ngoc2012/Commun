...
/*   Updated: 2023/01/23 16:59:20 by minh-ngu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	to_left(t_stack *st, int last, int last1)
{
	...
	while (st->cur[st->len - 1 - left].a_p < max_b)
		left++;
	right = 0;
	while (st->cur[right].a_p >= max_b - last1)
		right++;
...
void	to_left_end(t_stack *st, int last, int last1)
{
	int	max_b;
	int	left, right;
...
void	to_right(t_stack *st, int last)
{
	//int	k;
	int	max_b;
	//int	left, right;
...
void	to_right_end(t_stack *st, int last, int last1)
{
	//int	k;
	int	max_b;
	int	left, right;
