...
/*   Updated: 2023/01/28 17:50:30 by minh-ngu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	get_position(st);
//	to_right(st);
//	to_left_2(st, divide_third(st->push / 2), st->push / 2);
//	/*
//	last = st->push;
//	to_right(st);
//	last1 = st->push;
...
//		st->push--;
//	}
//	to_left(st, divide_third((st->push - last) / 2), (st->push - last) / 2);
//	to_left(st, divide_third(st->push - last), st->push - last);
//	to_left(st, divide_third(st->push / 2), st->push / 2); 
//	to_left(st, divide_third(st->push), st->push); 
//	*/
//}
