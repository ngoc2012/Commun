...
//a = ft_printf("s: %s, p: %p, d:%d", "a string", &main, 42);						//printf("%d\n", a);
//a = ft_printf("%s%p%d%d%p%s%p%p%s", "a", &free, 1, 2, &malloc, "b", &free, &malloc, "c");		//printf("%d\n", a);
//a = ft_printf("%s %d %p %% %x", "bonjour ", 42, &free, 42);						//printf("%d\n", a);
