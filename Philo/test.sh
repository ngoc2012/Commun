...
#echo "./philo 1 410 200 200"
#./philo 1 410 200 200
#echo "./philo 1 11 5 5"
#./philo 1 11 5 5
#echo "./philo 4 310 200 100"
#./philo 4 310 200 100
#echo "./philo 4 200 205 100"
#./philo 4 200 205 100
#echo "./philo 4 200 300 200"
#./philo 4 200 300 200
#echo "./philo 5 800 200 200 -5"
#./philo 5 800 200 200 -5
...
#echo "valgrind --leak-check=full ./philo 1 11 5 5"
#valgrind --leak-check=full ./philo 1 11 5 5
#echo "valgrind --tool=helgrind ./philo 5 800 200 200 5"
#valgrind --tool=helgrind ./philo 5 800 200 200 5
#echo "valgrind --leak-check=full ./philo 5 800 200 200 10"
#valgrind --leak-check=full ./philo 5 800 200 200 10
#echo "valgrind --tool=helgrind ./philo 4 310 200 100 10"
#valgrind --tool=helgrind ./philo 4 310 200 100 10
#echo "valgrind --leak-check=full ./philo 4 310 200 100 10"
#valgrind --leak-check=full ./philo 4 310 200 100 10
#echo "valgrind --tool=helgrind ./philo 4 410 200 200 5"
